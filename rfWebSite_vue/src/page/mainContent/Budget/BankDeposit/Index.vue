    ...
    <div class="BankDeposit">
        ...
        <div class="lunarCore">
            ...
            <div class="core_right">
                <div class="list">
                    <p><span class="name">借笔数：</span><span class="num">1</span></p>
                    <p><span class="name">贷笔数：</span><span class="num">1</span></p>
                    <p><span class="name">总笔数：</span><span class="num">2</span></p>
                </div>
                <div class="list">
                    <p><span class="name">借额：</span><span class="num">220.00</span></p>
                    <p><span class="name">贷额：</span><span class="num">0.00</span></p>
                </div>
                <div class="list">
                    <p><span class="name">上期结余：</span><span class="num">0.00</span></p>
                    <p><span class="name">本期结余：</span><span class="num">0.00</span></p>
                    <p><span class="name">月核人：</span><span class="num">0.00</span></p>
                </div>
            </div>
            <div style="clear: both"></div>
        </div>
        ...
        <div class="zll-dialog">
            <popout :title="title + '银行存款'" :visible.sync="addDialog" v-if="addDialog">
    ...
    export default {
        ...
        methods: {
            getTableList(){//获取表格数据
                ...
                setTimeout(()=>{
                    this.tableHeader =  [
                        {"columnValue": "tabledata1", "columnName": "交易日期"},
