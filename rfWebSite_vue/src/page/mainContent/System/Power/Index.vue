    ...
    export default {
        ...
        methods: {
             getTableList(){//获取表格数据
                ...
                setTimeout(()=>{
                    this.tableHeader =  [
                        {"columnValue": "tableNum1", "columnName": "设定日期"},
                        {"columnValue": "tableNum2", "columnName": "部门", width: "100"},
                        {"columnValue": "tableNum3", "columnName": "角色"},
                        {"columnValue": "tableNum4", "columnName": "权限"},
                        {"columnValue": "tableNum5", "columnName": "操作人", width: "100"},
                    ]
