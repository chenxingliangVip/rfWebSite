        ...
        data(){
            return {
                ...
                tableData: [{
                    ...
                    tableNum2: '张三',//姓名
                    tableNum3: '职务',//职务
                    tableNum4: '202001',//入职时间
                    tableNum5: '18251111111',//手机号
                    tableNum6: '启用',//状态
                }],
                tableHeader:[],
                selectList: [],
             ...
             getTableList(){//获取表格数据
                ...
                setTimeout(()=>{
                    this.tableHeader =  [
                        ...
                        {"columnValue": "tableNum2", "columnName": "姓名", width: "100"},
                        {"columnValue": "tableNum3", "columnName": "职务"},
                        {"columnValue": "tableNum4", "columnName": "入职时间", isSortable: true },
                        {"columnValue": "tableNum5", "columnName": "手机号"},
                        {"columnValue": "tableNum6", "columnName": "账号状态", width: "100"},
                    ]
