                ...
                <el-row :gutter="20">
					<el-col :span="8">
						<el-form-item class="formList" prop="addFormData4" label="审批人：">
							<el-input clearable class="input_right" placeholder="请输入审批人" v-model="addForm.addFormData4" :disabled="disabled"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item class="formList" prop="addFormData5" label="审批日期：">
							<el-date-picker type="date" placeholder="请选择审批日期" value-format="yyyy-MM-dd" v-model="addForm.addFormData5" :disabled="disabled"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="8">
						<el-form-item class="formList" prop="addFormData6" label="备注：">
							<el-input type="textarea" clearable class="input_right" placeholder="请输入备注" v-model="addForm.addFormData6" :disabled="disabled"></el-input>
						</el-form-item>
					</el-col>
				</el-row>
            </el-form>
