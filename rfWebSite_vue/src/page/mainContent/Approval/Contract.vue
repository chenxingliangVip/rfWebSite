<template>
    <div class="Account">
        ...
        <div class="zll-dialog">
            <popout :title="title + '合同'" :visible.sync="detailDialog" v-if="detailDialog">
            ...
            getTableList(){//获取表格数据
                ...
                setTimeout(()=>{
                    ...
                    this.tableHeader =  [
                        ...
                        {"columnValue": "tableNum2", "columnName": "报销人"},
                        {"columnValue": "tableNum3", "columnName": "年月度"},
                        {"columnValue": "tableNum4", "columnName": "状态"},
                        {"columnValue": "tableNum5", "columnName": "结算"},
                    ]
